<div class="container-fluid bg-primary mx-auto grid p-4" style="width: 100%;">
	<div class="row">
		<div class="col grid">
			<h2 class="fw-bold"><?= $dataToView->getNombre() ?></h2>
			...
			<div class="row"><p class="col fs-3 text-decoration-underline">CIF / NIF:</p><p class="col fs-4"><?= $dataToView->getCifNif() ?></p></div> <!-- CIF / NIF -->
		</div>
		<div class="col">
			<div class="grid row text-end pt-3">
				...
				<div class="row"><a href="index.php?action=verGestor"><button type="button" class="btn btn-light">Volver</button></a></div>
			</div>
		</div>
	</div>
</div>
<div class="container-fluid bg-light mx-auto grid p-4" style="width: 100%;">
	...
	<div class="row d-flex flex-row justify-content-around align-items-center flex-wrap p-5">
		<div class="column p-4" style="width: 45%;">
			...
			<div class="row d-flex flex-row justify-content-around align-items-center flex-wrap p-5">
				<?php
					foreach($_SESSION['gestor']->negociosUnido as $negocio){
						?>
		...
		<div class="column p-4" style="width: 45%;">
			...
			<div class="row d-flex flex-row justify-content-around align-items-center flex-wrap p-5">
				<?php
					if(count($_SESSION['gestor']->negociosInvitado) > 0){
						foreach($_SESSION['gestor']->negociosInvitado as $negocio){
							?>
